...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield client.repos.createDeploymentStatus(Object.assign({}, context.repo, { deployment_id: parseInt(deploymentId), state, log_url: logUrl, target_url: url, description, environment_url: environmentUrl }));
        }
        catch (error) {
            core.error(error);
